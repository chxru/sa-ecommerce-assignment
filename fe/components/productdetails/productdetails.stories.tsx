...
const Template: Story = (args) => <ProductDetails brandName={''} name={''} description={''} price={''} imageSrc={''} {...args} />;
...
Default.args = {
  ...
  price: '$58.00',
  imageSrc: 'https://www.nanotek.lk/uploads/product/2071-20230606093642-131a7a_27c314b0e76c41aea7eaa39de90eeb60~mv2.png',
};
